...
## [2026-09-07] project | Интерфейс по макету: дерево ДГК, KVM-ввод, пользователи и роли

Доведение web/ до макета InfraControl + «нормальная логика»:
- Дерево серверов: корень «ДГК» → филиалы по первым двум октетам IPv4
...
- Проверено headless (puppeteer): сворачивание (246↔64 + reload), дерево
  ДГК/филиалы, CRUD пользователей, 403 для user, скрытие/возврат кнопок,
