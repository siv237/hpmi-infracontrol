...
Подключено к реальному серверу: **PRIMERGY RX300 S6**, ServerView iRMC S2
Web Server, realm `iRMC S2@iRMC-P1-NODE1`.
...
- Дерево: корень «ДГК» → филиалы по первым двум октетам IPv4 (обезличенные
